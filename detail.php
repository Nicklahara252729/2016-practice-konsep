...
<div class="detail-barang">
    ...
    <div class="content-detail">
        ...
        <div class="isi-detail" id="detail-dua">
            ...
            <button type="button" class="btn-dk">+ Keranjang</button>
        </div>
...
<p><h1>DROP<b>BOOKS</b></h1><br><span>Toko Buku ditangan Anda ! Rasakan pengalaman membaca dan membeli buku dengan sekali klik</span><br><button type="button" class="btn-login">LOGIN</button> <button type="button" class="btn-register">REGISTER</button></p>
</div>
</div>
...
<li>SEJARAH</li>
<li>TEKNOLOGI</li>
<li><img src="img/keranjang.png" class="img-keranjang"></li>
</ul>
